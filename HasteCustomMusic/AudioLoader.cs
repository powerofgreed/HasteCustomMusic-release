...
public static class AudioLoader
{
    ...
    private static LoaderType[] GetLoadersInPriorityOrder(LoaderPriority priority)
    {
        ...
        {
            LoaderPriority.BassFirst => new[] { LoaderType.ManagedBass, LoaderType.Unity },
            LoaderPriority.OnlyUnity => new[] { LoaderType.Unity },
            _ => new[] { LoaderType.ManagedBass, LoaderType.Unity }
        };
    }
    ...
    private static LoaderPriority GetLoaderPriority() => MusicDisplayPlugin.CurrentLoaderPriority;
